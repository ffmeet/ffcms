@extends(\App\Support\SiteTheme::view('layout', 'themes.default.layout'), ['title' => '会员投稿'])
            ...
            <form method="POST" action="{{ route('member.posts.store') }}" enctype="multipart/form-data" class="grid gap-6 xl:grid-cols-[minmax(0,1fr)_320px]">
                ...
                <section class="space-y-6">
                    <div class="rounded-[28px] border border-stone-200/70 bg-white/90 p-6 shadow-sm">
                        ...
                        <textarea id="content" name="content" rows="9" required class="mt-3 w-full rounded-[24px] border border-stone-200 bg-stone-50 px-4 py-4 text-sm leading-7 text-stone-900 outline-none transition focus:border-amber-400 focus:bg-white">{{ old('content') }}</textarea>
                                ...
                                <div class="fixed inset-0 z-50 hidden p-4 sm:p-6" data-cover-library-panel>
                                    ...
                                    <div class="relative mx-auto mt-16 w-full max-w-3xl rounded-[18px] border border-slate-200 bg-white p-4 shadow-[0_18px_55px_rgba(148,163,184,0.18),0_6px_20px_rgba(191,219,254,0.16)] sm:mt-20 sm:p-5" data-cover-library-dialog>
                                        ...
                                        <label class="flex cursor-pointer items-center gap-3 border border-stone-200 bg-stone-50 px-4 py-3 text-sm text-stone-700">
                                            <input type="radio" name="cover_attachment_id" value="" @checked(blank(old('cover_attachment_id'))) class="text-amber-500 focus:ring-amber-400">
                                            <span>不使用媒体库图片</span>
                                        </label>
                    ...
                    <div class="rounded-[28px] border border-stone-200/70 bg-white/90 p-6 shadow-sm">
                        ...
                        <div class="mt-4 space-y-4">
                            ...
                            <div>
                                ...
                                <input id="seo_title" name="seo_title" type="text" value="{{ old('seo_title') }}" class="mt-2 w-full rounded-2xl border border-stone-200 bg-stone-50 px-4 py-3 text-sm text-stone-900 outline-none transition focus:border-amber-400 focus:bg-white">
                            </div>

                            <div>
                                <label for="tags" class="text-sm font-medium text-stone-700">标签</label>
                                <input id="tags" name="tags" type="text" value="{{ old('tags') }}" placeholder="例如：CMS, Laravel, 新闻" class="mt-2 w-full rounded-2xl border border-stone-200 bg-stone-50 px-4 py-3 text-sm text-stone-900 outline-none transition focus:border-amber-400 focus:bg-white">
                            </div>
